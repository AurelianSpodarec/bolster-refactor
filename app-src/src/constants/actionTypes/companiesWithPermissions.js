...
export const ADD_COMPANY_PERMISSIONS_REQUEST =
    'ADD_COMPANY_PERMISSIONS_REQUEST';
export const ADD_COMPANY_PERMISSIONS_SUCCESS =
    'ADD_COMPANY_PERMISSIONS_SUCCESS';
export const ADD_COMPANY_PERMISSIONS_FAILURE =
...
export const EDIT_COMPANY_PERMISSIONS_REQUEST =
    'EDIT_COMPANY_PERMISSIONS_REQUEST';
export const EDIT_COMPANY_PERMISSIONS_SUCCESS =
    'EDIT_COMPANY_PERMISSIONS_SUCCESS';
export const EDIT_COMPANY_PERMISSIONS_FAILURE =
    'EDIT_COMPANY_PERMISSIONS_FAILURE';

export const CLIENT_FETCH_COMPANY_PERMISSIONS_REQUEST =
    'CLIENT_FETCH_COMPANY_PERMISSIONS_REQUEST';
export const CLIENT_FETCH_COMPANY_PERMISSIONS_SUCCESS =
    'CLIENT_FETCH_COMPANY_PERMISSIONS_SUCCESS';
export const CLIENT_FETCH_COMPANY_PERMISSIONS_FAILURE =
