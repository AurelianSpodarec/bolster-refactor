...
export const FETCH_SINGLE_INVOICE_ITEMS_FAILURE =
    ...
    export const FETCH_SINGLE_INVOICE_PAYMENTS_REQUEST =
    'FETCH_SINGLE_INVOICE_PAYMENTS_REQUEST';
export const FETCH_SINGLE_INVOICE_PAYMENTS_SUCCESS =
    'FETCH_SINGLE_INVOICE_PAYMENTS_SUCCESS';
export const FETCH_SINGLE_INVOICE_PAYMENTS_FAILURE =
