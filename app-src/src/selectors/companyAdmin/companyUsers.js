...
export const selectCompanyUsersIsPosting = state =>
    state.companyAdmin.companyUsersReducer.isPosting;
export const selectCompanyUsersPostSuccess = state =>
    state.companyAdmin.companyUsersReducer.postSuccess;
...
export const selectUserFilters = state => state.companyAdmin.companyUsersReducer.userFilters;
