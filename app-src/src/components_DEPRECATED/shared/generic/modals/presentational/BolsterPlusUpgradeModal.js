...
import BolsterPlusHeading from 'pages/dashboard/companyAdmin/subscription/addOns/BolsterPlusHeading';
import BolsterPlusFeatures from 'pages/dashboard/companyAdmin/subscription/addOns/BolsterPlusFeatures';
...
const BolsterPlusUpgradeModal = ({ shouldGoBack, handleClose, hideModal, handleSwitchTab }) => {
