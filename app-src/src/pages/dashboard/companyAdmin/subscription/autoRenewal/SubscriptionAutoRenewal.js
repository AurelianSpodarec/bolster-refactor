            ...
            <Form className="size-lg-12">
                ...
                <div className="generic-form no-min-heights size-lg-12">
                    ...
                    <Field htmlFor="radio-invoice">
                        ...
                        {expiresWithin2Days && (
                            <p
                                className="size-lg-12 info-message warning"
                                style={{ paddingTop: 10 }}
                            >
                                <strong>Note:</strong> You will be able to update your payment
                                method when your new subscription begins.
                            </p>
                        )}
                    </Field>
                </div>
