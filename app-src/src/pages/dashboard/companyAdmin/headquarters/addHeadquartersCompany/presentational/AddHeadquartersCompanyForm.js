...
const AddHeadquartersCompanyForm = ({
    ...
    return (
        <Form className="generic-form size-lg-12 size-lg-12" onSubmit={handleSubmit}>
            {/* company information */}
            ...
            <div className="size-lg-12">
                ...
                <div className="size-lg-6 size-md-12">
                    {isVatCodeRequired && (
                        <Field name="VAT Code" required={isVatCodeRequired}>
                            <TextInputContainer
            ...
            <BlockButtonWrapper>
                ...
                <ButtonContainer to="/company/headquarters/companies">Cancel</ButtonContainer>
            </BlockButtonWrapper>
        </Form>
    );
};
