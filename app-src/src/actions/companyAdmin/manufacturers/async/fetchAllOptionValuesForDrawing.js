...
export const fetchOptionValuesByManufacturerRequest = () => ({
    type: FETCH_ALL_OPTION_VALUES_FOR_DRAWING_REQUEST,
});

export const fetchOptionValuesByManufacturerSuccess = payload => ({
    type: FETCH_ALL_OPTION_VALUES_FOR_DRAWING_SUCCESS,
    payload,
});

export const fetchOptionValuesByManufacturerFailure = error => ({
    type: FETCH_ALL_OPTION_VALUES_FOR_DRAWING_FAILURE,
    error,
});
...
export default drawingID => dispatch => {
    ...
    return axios
        .get(`${API_URL}/manufacturer/optionvalues/all/${drawingID}`, getHeaders())
