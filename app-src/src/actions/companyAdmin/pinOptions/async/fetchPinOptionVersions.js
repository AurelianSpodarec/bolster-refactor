...
export const fetchPinOptionVersionsRequest = () => ({
    type: FETCH_PIN_OPTION_VERSIONS_REQUEST,
});

export const fetchPinOptionVersionsSuccess = payload => ({
    type: FETCH_PIN_OPTION_VERSIONS_SUCCESS,
    payload,
});

export const fetchPinOptionVersionsFailure = error => ({
    type: FETCH_PIN_OPTION_VERSIONS_FAILURE,
    error,
});
...
export default () => async dispatch => {
    ...
    return axios
        .get(`${API_URL}/pinoptions/versions`, getHeaders())
