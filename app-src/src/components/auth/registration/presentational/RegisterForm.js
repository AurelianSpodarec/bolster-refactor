    ...
    return (
        <BlockContainer error={error}>
            ...
            <Form className="generic-form size-lg-12" onSubmit={handleSubmit}>
                ...
                <Field name="Confirm password" sizeClasses="size-lg-4 size-md-12" required>
                    <TextInputContainer
                ...
                <Field name="Business name" sizeClasses="size-lg-4 size-md-12" required>
                    <TextInputContainer
                        value={name}
                        name="Company.name"
                ...
                <Field name="Address Line 1" sizeClasses="size-lg-4 size-md-12" required>
                    <TextInputContainer
                        value={addressLine1}
                ...
                <Field name="Address Line 2" sizeClasses="size-lg-4 size-md-12">
                    <TextInputContainer
                        value={addressLine2}
                ...
                <div className="button-area size-lg-12">
                    {terms ? (
                        ...
                        <button className="button green disabled" disabled type="submit">
                            Submit
                        </button>
                    )}
