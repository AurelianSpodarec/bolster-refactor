        ...
        <ol>
                <li>
                    ...
                    <p>
                        ...
                        access the Web Platform to manage and administer the Licenced
                        Product, currently www.bolstersystems.com.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        partnership), members (if the Customer is a limited liability
                        partnership), officers (if the Customer is a corporate body) and
                        employees who are authorised to access and use the Licenced
                        Product in accordance with these terms and conditions.
                    </p>
                    <p>
                        <strong>Building Owner</strong>:- the owner or its authorised representatives of the
                        building, property or construction (or any part therefore) which is the
                        subject of any use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Building Owner</strong>:- the owner or its authorised representatives of the
                        building, property or construction (or any part therefore) which is the
                    ...
                    <p>
                        <strong>Content</strong>:- all documents, text, information, data, software, executable code, access codes, images, audio or video material in whatever medium or form comprised in or used with the Licensed Product other than the Customer Data.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        Users, or Bolster on the Customer's behalf for the purpose of using
                        the Licensed Product or facilitating the Customer’s use of the
                        Licensed Product.
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>Licence</strong>:- the user subscription purchased by the Customer that entitles Authorised Users to access and use the Licensed Product, in accordance with these terms and conditions.
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>Purpose</strong>:- fire safety surveying of buildings and properties and the monitoring and administration of such surveys by the Customer and Authorised Users.
                    </p>
                    <p>
                        <strong>Registration Form</strong>:- Bolster’s order form for the Licensed Product on which the Customer registers for use of the Licensed Product on the relevant product platform.
                    </p>
                    <p>
                        <strong>Subscription Fee</strong>:- the fee payable by the Customer for the use of the Licenced Product as set out in the Registration Form.
                    </p>
                    <p>
                        <strong>Supplier</strong>:- Bolster Systems Limited (company number 09148744) whose registered office is at 7 The Schoolhouse Second Avenue, Trafford Park, Manchester, Greater Manchester, England, M17 1DZ.
                    </p>
                    <p>
