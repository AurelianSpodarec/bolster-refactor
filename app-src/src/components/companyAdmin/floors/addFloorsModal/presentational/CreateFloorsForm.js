        ...
        <div className="size-lg-12">
            {floors.map((floor, i) => (
                <>
                    ...
                    {floors.setManufacturersForHierarchy && (
                        <div className="size-lg-12">
                            <Field labelClasses="no-capitalise" name="Manufacturer(s)">
                                <CheckboxListContainer
                                    name={`${floors.id}.*.selectedManufacturerOptions`}
                                    text=""
                                    handleChange={(name, value) =>
                                        updateFloor(name, value, floors.id)
                                    }
                                    selectedOptions={floors.selectedManufacturerOptions}
                                    options={floors.manufacturerOptions}
                                    allOptionsDisabled={floors.isManufacturingSetAbove}
                                />
                            </Field>
                        </div>
                    )}
                    ...
                    {floor.setManufacturersForHierarchy &&
                        Object.entries(floor.optionValuesOptions).map(
                            ([manufacturerID, optionValues]) => {
                                if (floor.selectedManufacturerOptions.includes(manufacturerID)) {
