        ...
        {shouldRestrictPayments ? (
            <>
                ...
                <p className="info-message error" style={{ marginTop: '15px' }}>
                    This account has been restricted from payments, please
                    contact your company admin for further information.
                </p>
            </>
        ) : (
            <>
                ...
                {active ? (
                    subscriptions.isAutoRenew ? (
                        <>
                            ...
                            {noCards &&
                                subscriptions.renewalType ===
                                    ...
                                    >
                                        Your auto-renewal is set to use a card
                                        payment, however you do not have any
                                        cards set up. Please set up a card or
                                        switch to invoice.
                                    </p>
                                )}
                            {subscriptions.renewalType !==
                                ...
                                subscriptions.renewalType !==
                                    ...
                                    <p
                                        ...
                                        style={{ marginTop: '15px' }}
                                    >
                                        You have auto-renewal turned on, however
                                        have not selected a payment method.
                        ...
                        <p className="size-lg-12">
                            Company subscription is not set to auto-renew and
                            will end on{' '}
                            <strong>
                                <DateTimeContainer date={endOn} />
                            </strong>
                    ...
                    <p className="size-lg-12">
                        You have no subscription, please add a service to
                        subscribe and gain access to the site.
                    </p>
                )}
            </>
        )}
