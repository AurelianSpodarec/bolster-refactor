...
const EditActivityLogForm = ({
    ...
    return (
        <>
            <BlockButtonWrapper additionalClasses="no-margin">
                <button className="button green" type="button" onClick={selectAll}>
                    Select all
                </button>
                <button className="button red" type="button" onClick={deselectAll}>
                    Deselect all
                </button>
            </BlockButtonWrapper>
