...
import editOptionValueDocument from 'actions/companyAdmin/manufacturers/async/editOptionValueDocument';
...
class EditOptionValueDocumentFormContainer extends Component {
    ...
    handleSubmit = e => {
        e.preventDefault();
        const { editOptionValueDocument, optionValueID, document, manufacturerID } = this.props;
        const postBody = {
            ...this.state,
        };
        editOptionValueDocument(manufacturerID, optionValueID, document.id, postBody);
    };
}
