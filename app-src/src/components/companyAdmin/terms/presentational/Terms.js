...
const Terms = () => (
    <>
        <PageHeading leftChildren={true} title="Terms & Conditions"><BackButtonContainer/></PageHeading>
        <BlockContainer>
        ...
        <ol>
                <li>
                    ...
                    <p>
                        <strong>Administration Site</strong>:- the website from which the Customer can access the Web Platform to manage and administer the Licenced Product, currently www.bolstersystems.com.
                    </p>
                    <p>
                        <strong>Agreement</strong>:- the agreement for the purchase of the Licensed Product in accordance with these terms and conditions.
                    </p>
                    <p>
                        <strong>App</strong>:- the Bolster Systems mobile surveying application software, the data supplied with the software, and any associated media.
                    </p>
                    <p>
                        <strong>Authorised Users</strong>:- the Customer’s partners (if the Customer is a partnership), members (if the Customer is a limited liability partnership), officers (if the Customer is a corporate body) and employees who are authorised to access and use the Licenced Product in accordance with these terms and conditions.
                    </p>
                    <p>
                        <strong>Building Owner</strong>:- the owner or its authorised representatives of the building, property or construction (or any part therefore) which is the subject of any use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Building Owner</strong>:- the owner or its authorised representatives of the building, property or construction (or any part therefore) which is the subject of any use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Commencement Date</strong>:- the date the Customer purchases the Licence Product and pays the Subscription Fee.
                    </p>
                    <p>
                        <strong>Content</strong>:- all documents, text, information, data, software, executable code, access codes, images, audio or video material in whatever medium or form comprised in or used with the Licensed Product other than the Customer Data.   </p>
                    <p>
                        <strong>Contract Year</strong>:- the 12 month period from the Commencement Date and each succeeding 12-month period.
                    </p>
                    <p>
                        <strong>Customer</strong>:-  the customer specified in the Registration Form who is purchasing the Licensed Product.
                    </p>

                    <p>
                        <strong>Customer Data</strong>:- the data inputted by the Customer, Authorised Users, or Bolster on the Customer's behalf for the purpose of using the Licensed Product or facilitating the Customer’s use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Initial Subscription Term</strong>:-  the period set out in the Registration Form.
                    </p>
                    <p>
                    ...
                    <p>
                        <strong>Licence</strong>:- the user subscription purchased by the Customer that entitles Authorised Users to access and use the Licensed Product, in accordance with these terms and conditions.            </p>
                    <p>
                        <strong>Licensed Product</strong>:- access to and use of the Web Platform and/or the App together with any relevant Content, any error corrections or updates that Bolster may provide or perform with respect to the Web Platform and/or the App as specified in the Registration Form.
                    </p>
                    <p>
                        <strong>Project</strong>:- a project to be undertaken by the Customer using the Licensed Product for the Purpose.
                    </p>
                    <p>
                        <strong>Project Credits</strong>:- payment credits allowing the Customer to upload Projects for the Purpose.
                    </p>
                    <p>
                        <strong>Project Credit Fee</strong>:- the fee payable by the Customer for Project Credits as set out in the Registration Form.
                    </p>
                    <p>
                        <strong>Purpose</strong>:- fire safety surveying of buildings and properties and the monitoring and administration of such surveys by the Customer and Authorised Users. </p>
                    <p>
                        <strong>Registration Form</strong>:- Bolster’s order form for the Licensed Product on which the Customer registers for use of the Licensed Product on the relevant product platform.          </p>
                    <p>
                        <strong>Subscription Fee</strong>:-  the fee payable by the Customer for the use of the Licenced Product as set out in the Registration Form.             </p>
                    <p>
                        <strong>Supplier</strong>:- Bolster Systems Limited (company number 09148744) whose registered office is at 7 The Schoolhouse Second Avenue, Trafford Park, Manchester, Greater Manchester, England, M17 1DZ.            </p>
                    <p>
                        <strong>Web Platform</strong>:-  the web based application software accessed through the Administration Site for the managing and administration of fire safety surveys and associated works.
                    </p>
                </li>
                <li>
                    <h4>
                ...
                <li>
                    ...
                    <ol>
                        <li>
                            <p>
                                provide the Licensed Product to the Customer on the terms of the Agreement in all material respects;
                            </p>
                        </li>
                        <li>
                            <p>
                                provide such support to the Customer as is reasonably necessary to allow the Customer and the Authorised Users to use the Licensed Product in accordance with its support policy in effect at the time the Licensed Product is provided and as published on Bolster’s website www.bolstersystems.co.uk, or as otherwise notified to the Customer by Bolster in writing from time to time. Bolster may amend the support policy in its sole and absolute discretion from time to time;
                            </p>
                        </li>
                        <li>
                            <p>
                                comply with all applicable laws and regulations, including those relating to anti-bribery and anti-corruption.
                            </p>
                        </li>
                    </ol>
                    <p>
            ...
            <li>
                ...
                <ol>
                    <li>
                        <p>
                            co-operate with Bolster in all matters relating to the Licensed Product;
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                        ensure each Authorised User keeps a secure password for his use of the Licensed Product and Content and that each Authorised User shall keep his password confidential;
                        </p>
                    </li>
                    <li>
                        <p>
                        ensure that each Authorised User accepts and complies with Bolster’s end user licence agreement (“EULA”) for the Licensed Product from time to time;
                        </p>
                    </li>
                    <li>
                        <p>
                        notify Bolster as soon as it becomes aware of any unauthorised use of the Licensed Product by any person;
                        </p>
                    </li>
                    <li>
                        <p>
                        not (save as is necessary for the completion or use of the Licensed Product for the Purpose) download, store, reproduce, display, print, distribute, publish the Content whether in whole or part, and in any manner, form or media without the prior written consent of Bolster;
                        </p>
                    </li>
                    <li>
                        <p>
                        the Customer will be responsible for setting up each Authorised User with access to the relevant Licensed Product. The Customer must ensure that each person having access to the Licensed Product is an Authorised User and uses the Licensed Product only in accordance with these terms and conditions;
                        </p>
                    </li>
                    <li>
                        <p>
                        not use any information provided by Bolster or obtained by the Customer and Authorised Users by using the Licensed Product to create any software or product where the use is substantially similar to that of the Licensed Product;
                        </p>
                    </li>
                    <li>
                        <p>
                        not access all or any part of the Licensed Product in order to create a product or service which competes with the Licensed Product;
                        </p>
                    </li>
                    <li>
                        <p>
                        not use such information in any manner which would be restricted by any copyright subsisting in it;
                        </p>
                    </li>
                    <li>
                        <p>
                        not use the Licensed Product to provide any similar or other services to third parties;
                        </p>
                    </li>
                    <li>
                        <p>
                        not license, sell, rent, lease, transfer, assign, distribute, display, disclose, or otherwise commercially exploit, or otherwise make the Licensed Product available to any third party except the Authorised Users.
                        </p>
                    </li>
                </ol>
                <p>
            ...
            <li>
                ...
                <ol>
                    <li>
                        <p>
                        Bolster may, without liability to the Customer, disable the Customer's and/or any Authorised User’s password, account and access to all or part of the Licensed Product and Content and shall be under no obligation to provide access to the Licensed Product and/or Content while the invoice(s) concerned remain unpaid; and
                        </p>
                    </li>
                    <li>
                        <p>
                        the Customer shall pay interest on the overdue amount at the rate of 4% per annum above Barclays Bank plc's base rate from time to time. Such interest shall accrue on a daily basis from the due date until actual payment of the overdue amount, whether before or after judgment.
                        </p>
                    </li>
                </ol>
            </li>
            ...
            <li>
                ...
                <ol>
                    <li>
                    any Customer Data provided to Bolster is owned by the Customer;
                    </li>
                    <li>
                    it has received the necessary consents or permissions to use the Customer Data in accordance with this Agreement from the applicable owner(s);
                    </li>
                    <li>
                    the Customer Data does not include any material that is obscene, indecent, pornographic, seditious, offensive, defamatory, threatening, liable to incite racial hatred or acts of terrorism, menacing, or blasphemous; or
                    </li>
                    <li>
                    the Customer Data does not infringe any third party Intellectual Property Rights,
                    </li>
                </ol>
                <p>
                ...
                <ol>
                    <li>
                    the Customer acknowledges and agrees that the personal data may be transferred or stored outside the EEA or the country where the Customer and the Authorised Users are located in order to provide the Licensed Product and Bolster's other obligations under this Agreement;
                    </li>
                    <li>
                    the Customer shall ensure that the Customer is entitled to transfer the relevant personal data to Bolster so that Bolster may lawfully use, process and transfer the personal data in accordance with this agreement on the Customer's behalf;
                    </li>
                    <li>
                    ...
                    <li>
                    Bolster shall process the personal data only in accordance with the terms of this Agreement and any lawful instructions reasonably given by the Customer from time to time; and
                    </li>
                    <li>
                    each party shall take appropriate technical and organisational measures against unauthorised or unlawful processing of the personal data or its accidental loss, destruction or damage.                    </li>
                </ol>
            </li>
            <li>
                <h4>
                ...
                <ol>
                    <li>
                        the Customer owns such requirements or materials (or is authorised to provide them to Bolster for such purposes;
                    </li>
                    <li>
                        the provision of such materials or requirements to Bolster and the provision of a template based on such materials or requirements within the Licensed Product shall not infringe the Intellectual Property Rights of any third party.    
                    </li>
                </ol>
                <p>
            ...
            <li>
                ...
                <ol>
                    ...
                    <li>
                    in respect of any use made by the Customer of the Licensed Products and Content or any part of them; and
                    </li>
                    <li>
                    in respect of any use made by the Customer of the Licensed Products and Content or any part of them; and
                    </li>
            ...
            <li>
                ...
                <ol>
                    ...
                    <li>
                        <p>
                        the Customer shall (and shall procure that all Authorised Users shall) make no further use of the Licensed Products and Content;
                        </p>
                    </li>
                    <li>
                        <p>
        ...
        <WysiwygBlock>
            <ol>
                <li>
                <h4>
                This end-user licence agreement (“EULA”) is a legal agreement between you (“End-user” or “you”) and Bolster Systems Limited (company number 09148744) whose registered office is at The Studio, The Schoolhouse, Second Avenue, Trafford Park, Manchester M17 1DZ (“Bolster”, “us” or “we”) for the access to and use of:
                    
                </h4>
                    <ol>
                        <li>
                        Bolster Systems mobile application software once you have downloaded or streamed a copy of the application onto your mobile telephone or handheld device, the data supplied with the software, and the associated media (the “<strong>App</strong>”);

                        </li>
                        <li>
                        the web based platform software accessible through our website www.bolstersystems.com (“<strong>Website</strong>”) (the “<strong>Web Platform</strong>”); and
                        </li>
                        <li>
                        all documents, text, information, data, software, executable code, access codes, images, audio or video material in whatever medium or form comprised in or used with the App and/or the Web Platform other than the Customer Data (defined below) (“<strong>Content</strong>”),
                        </li>
                    </ol>
                    <p>
                    together with any error corrections or updates that Bolster may provide or perform with respect to the Web Platform and/or the App from time to time (the “<strong>Licensed Product</strong>”).
                    </p>
                ...
                <li>
                    ...
                    <p>
                    The App requires an iPhone device with a minimum of [amount] of memory. Internet access and the [type of operating system] operating system [version of operating system]. [any further requirements].

                    </p>
                    <p>
                    The Web Platform requires internet access and the [type of operating system] operating system [version of operating system] [amount] of memory] [any further requirements].
                ...
                <li>
                    ...
                    <p>
                    By downloading the App or using the Licensed Product from the Website or clicking on the "accept" button below you agree to the terms of the licence which will bind you. The terms of the licence include, in particular, the privacy policy defined in condition 5 and limitations on liability in condition 10.
                ...
                <li>
                    ...
                    <p>
                        <strong>Authorised Users</strong>:- the Licensee’s partners (if the Customer is a partnership), members (if the Customer is a limited liability partnership), officers (if the Customer is a corporate body) and employees who are authorised to access and use the Licenced Product in accordance with these terms and conditions.
                    </p>
                    <p>
                        <strong>Building Owner</strong>:- the owner or its authorised representatives of the building, property or construction (or any part therefore) which is the subject of any use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Customer Data</strong>:- the data inputted by you, any other Authorised User or Bolster on your behalf for the purpose of using the Licensed Product or facilitating your use of the Licensed Product.
                    </p>
                    <p>
                        <strong>Licensee</strong>:- the customer specified in the Registration Form who purchased the subscription for the Licensed Product for your use as an Authorised User.
                    </p>
                    <p>
                        <strong>Overarching Licence Agreement</strong>:- the agreement for the purchase of the subscription for the Licensed Product by the Licensee under which you are authorised to use the Licensed Product as an Authorised User.
                    </p>
                    <p>
                        <strong>Registration Form</strong>:- Bolster’s order form for the Licensed Product on which the Licensee registers for use of the Licensed Product on the relevant product platform.
                    </p>
                </li>
                <li>
                    <h4>
                    ...
                    <ol>
                        <li>
                        if you are downloading or streaming the App, download or stream a copy of the App onto your Device (as defined in this clause 5 below) and view, use and display the App on your Device for your business purposes only;

                            </li>
                            <li>
                            if you are using the Web Platform, you may use the Web Platform for your own business purposes as set out in the EULA; and

                            </li>
                            <li>
                            use the Content for your own business purposes only.

                            </li>
                    </ol>
                    <p>
                    We license use of the Licensed Product to you on the basis of this EULA and subject to any rules or policies applied by any provider of a service allowing the download of the App (“<strong>Apple App Store & Google Play Store</strong>”) where, the End-user downloaded the App (“<strong>Appstore Rules</strong>”). We do not sell the Licensed Product (or any part of it) to you. We remain the owners of the Licensed Product at all times.
                    </p>
                    <p>
                    ...
                    <p>
                        You will be assumed to have obtained permission from the owners of the mobile telephone or handheld devices that are controlled, but not owned by you to use the Licensed Product (“<strong>Devices</strong>”) and to download or stream a copy of the App onto the Devices. You and they may be charged by your and their service providers for internet access on the Devices. You accept responsibility in accordance with the terms of this EULA for the use of the Licensed Product in relation to any Device or the Web Platform, whether or not it is owned by you.
                    </p>
                    <p>
                        The terms of our privacy policy from time to time, available at www.bolstersystems.com (“<strong>Privacy Policy</strong>”) are incorporated into this EULA by reference and apply to your use of the Licensed Product. Additionally, by using the Licensed Product, you acknowledge and agree that internet transmissions are never completely private or secure. You understand that any message or information you send using the Licensed Product may be read or intercepted by others, even if there is a special notice that a particular transmission is encrypted.
                    </p>
                    <p>
                    ...
                    <p>
                        The Licensed Product may contain links to other independent third- party websites (“<strong>Third-party Sites</strong>”). Third-party Sites are not under our control, and we are not responsible for and do not endorse their content or their privacy policies (if any). You will need to make your own independent judgement regarding your interaction with any Third-party Sites, including the purchase and use of any products or services accessible through them.
                    </p>
                </li>
                <li>
                    <h4>
                    ...
                    <ol>
                        <li>
                            not use the Licensed Product in any unlawful manner, for any unlawful purpose, or in any manner inconsistent with this EULA, or act fraudulently or maliciously, for example, by hacking into or inserting malicious code, including viruses, or harmful data, into the Licensed Product or any operating system;
                        </li>
                        <li>
                            not infringe our intellectual property rights or those of any third party in relation to your use of the Licensed Product, including the submission of any material (to the extent that such use is not licensed by this EULA);
                        </li>
                        <li>
                            not transmit any material that is defamatory, offensive or otherwise objectionable in relation to your use of the Licensed Product;
                        </li>
                        <li>
                            not use the licensed Product in a way that could damage, disable, overburden, impair or compromise our systems or security or interfere with other users; and
                        </li>
                        <li>
                            not collect or harvest any information or data from the Licensed Product or any service or our systems or attempt to decipher any transmissions to or from the servers running any Licensed Product.
                        </li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        <li>
                            provide the Licensed Product on the terms of this EULA in all material respects;
                        </li>
                        <li>
                            provide such support to you as is reasonably necessary to allow you as an Authorised User to use the Licensed Product in accordance with its support policy in effect at the time the Licensed Product is provided and as published on Bolster’s website <a href="/">www.bolstersystems.co.uk</a>, or as otherwise notified to you or the Licensee by Bolster in writing from time to time. Bolster may amend the support policy in its sole and absolute discretion from time to time;
                        </li>
                        <li>
                            comply with all applicable laws and regulations, including those relating to anti-bribery and anti-corruption.
                        </li>
                    ...
                    <p>
                    Bolster does not warrant that (a) your use of the Licensed Product will be uninterrupted or error-free and you acknowledge that the Licensed Product may be interrupted by planned or unplanned maintenance; (b) the Licensed Product and/or the information obtained by you through the Licensed Product will meet your requirements.
                    </p>
                </li>
                <li>
                    <h4>
                    ...
                    <ol>
                        ...
                        <li>
                            keep a secure password for your use of the Licensed Product and shall keep your password confidential;
                        </li>
                        <li>
                            notify Bolster as soon as you become aware of any unauthorised use of the Licensed Product by any person;
                        </li>
                        <li>
                            not use any information provided by Bolster or obtained by the Licensee or any Authorised Users by using the Licensed Product to create any software or product where the use is substantially similar to that of the Licensed Product;
                        </li>
                        <li>
                        not access all or any part of the Licensed Product in order to create a product or service which competes with the Licensed Product;
                        ...
                        <li>
                        not copy the Licensed Product except where such copying is incidental to normal use of the Licensed Product, or where it is necessary for the purpose of back-up or operational security;

                        </li>
                        <li>
                        not make alterations to, or modifications of, the whole or any part of the Licensed Product, or permit the Licensed Product or any part of them to be combined with, or become incorporated in, any other programs;

                        </li>
                        <li>not use the Licensed Product to provide any similar or other services to third parties; and
                        </li>
                        <li>
                            not license, sell, rent, lease, transfer, assign, distribute, display, disclose, or otherwise commercially exploit, or otherwise make the Licensed Product available to any third party.
                        </li>
                    </ol>
                    <p>
                ...
                <li>
                    ...
                    <p>
                    For the purpose of this clause Intellectual Property Rights means patents, rights to inventions, copyright and related rights, trade marks, business names and domain names, rights in get-up, goodwill and the right to sue for passing off, rights in designs, database rights, rights to use, and protect the confidentiality of, confidential information (including know-how), and all other intellectual property rights, in each case whether registered or unregistered and including all applications and rights to apply for and be granted, renewals or extensions of, and rights to claim priority from, such rights and all similar or equivalent rights or forms of protection which subsist or will subsist now or in the future in any part of the world (“<strong>Intellectual Property Rights</strong>”).
                    </p>
                    <p>
                    ...
                    <ol>
                        <li>
                        any Customer Data or content uploaded to the Licensed Product by you may be viewed by the Building Owner if the Building Owner utilises any Licensed Product for itself. You grant to Bolster a worldwide, non-exclusive, royalty free, sub-licensable, irrevocable licence to allow the Building Owner to utilise any Customer Data or content uploaded to the Licensed Product by you.
                        </li>
                        <li>
                        where Bolster creates a template pursuant to Your request Bolster shall be entitled (and You hereby grant Bolster a worldwide, non-exclusive, royalty free, sub-licensable, irrevocable licence) to reuse any template created  (or to create and use derivative templates) with other customers of Bolster (whether as an integral part of the Licensed Product or in relation to requests from other customers).
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            in respect of any use made by you of the Licensed Products and Content or any part of them; and
                        </li>    
                        <li>
                            in respect of any representation, statement or tortious act or omission (including negligence) arising under or in connection with this EULA.
                        </li>     
                    </ol>
                    <p>
                        Except as expressly and specifically provided in this EULA:
                    </p>
                    <ol>
                        <li>
                        ...
                        <li>
                            all warranties, representations, conditions and all other terms of any kind whatsoever implied by statute or common law are, to the fullest extent permitted by applicable law, excluded from this EULA;
                        </li>
                        <li>
                            the Licensed Products and the Content are provided to you on an "as is" basis; and
                        </li>
                        <li>
                            we will not be liable to you for your use of the Licensed Product as our total liability for the provision of the Licensed Product to you is to the Licensee in accordance with the Overarching Licence Agreement.
                        </li>
                    </ol>
                    <p>
                        Nothing in this Agreement excludes the liability of Bolster:
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            the Overarching Licence Agreement expires or is terminated in accordance with the terms of the Overarching Licence Agreement; and
                        </li>
                        <li>
                        ...
                        <li>
                            if you cease to work for the Licensee for whatever reason.
                        </li>
                    </ol>
                    <p>
                        On termination of this Agreement for any reason:
                    ...
                    <ol>
                        ...
                        <li>
                            you shall make no further use of the Licensed Products and you must immediately cease all activities authorised by this EULA;
                        </li>
                        <li>
                            if applicable you must immediately delete or remove the App from all Devices, and immediately destroy all copies of the App and Content then in your possession, custody or control and certify to us that you have done so;
                        </li>
                        <li>
                            we may remotely access the Devices and remove the App from all of them and cease providing you with access to the App and Web Platform.
                        </li>
                        <li>
                            any rights, remedies, obligations or liabilities of the parties that have accrued up to the date of termination, including the right to claim damages in respect of any breach of the agreement which existed at or before the date of termination shall not be affected or prejudiced; and
                        </li>
                ...
                <li>
                    ...
                    <p>
                    If you wish to contact us in writing, or if any condition in this EULA requires you to give us notice in writing, you can send this to us by e-mail or by prepaid post to Bolster Systems Limited at 7 The School House, Second Avenue, Trafford Park, Manchester M17 1DZ and [E-MAIL ADDRESS]. We will confirm receipt of this by contacting you in writing, normally by e-mail.
                    </p>
                    <p>
    ...
    <BlockContainer>
        ...
        <WysiwygBlock>
            ...
            <ul>
                <li>
                <p>the Bolster Systems mobile application software (“<strong>App</strong>”) hosted on www.bolstersystems.com  (“<strong>Website</strong>”), once you have downloaded or streamed a copy of the App onto your mobile telephone or handheld device (“<strong>Device</strong>”) and any services accessible through the App; and</p>
                </li>
                <li>
                <p>our Website and any of the services accessible through the Website including the web portal access (“<strong>Services</strong>”) that are available on the Website or other sites of ours (“<strong>Services Sites</strong>”).</p>
                </li>
            </ul>
            <p>
            ...
            <ol>
                ...
                <li>
                    <NavHashLink to="/company/terms#security">
                        DATA SECURITY
                    </NavHashLink>
                </li>
                <li>
                    <NavHashLink to="/company/terms#retention">
                        DATA RETENTION
                    </NavHashLink>
                </li>
                <li>
                    <NavHashLink to="/company/terms#rights">
                        YOUR LEGAL RIGHTS
                    </NavHashLink>
                </li>
                <li>
                    <NavHashLink to="/company/terms#glossary">
                        GLOSSARY
                    </NavHashLink>
                </li>
            </ol>
            <ol>
                <li id="important">
                    ...
                    <p>
                        Name or title of data privacy manager: Wesley Donlon
                    </p>
                    <p>
                        Email address: info@bolstersystems.com 
                    </p>
                    <p>
                        Postal address: 7 The Schoolhouse Second Avenue, Trafford Park, Manchester, Greater Manchester M17 1DZ
                    </p>
                    <p>
                    ...
                    <p>
                        This version was last updated on [11/04/2019] and historic versions can be obtained by contacting us. 
                    </p>
                    <p>
                ...
                <li id="data">
                    ...
                    <ul>
                        <li>
                            <p><strong>Identity Data</strong> includes first name, last name, username or similar identifier.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Usage Data</strong> includes information about how you use our Website, App, Service Sites, products and services. </p>
                        </li>
                        <li>
                ...
                <li id="personalCollected">
                    ...
                    <ul>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            advertising networks [such as [NAME] based [inside <strong>OR</strong> outside] the EU]; and
                                        </li>
                                        <li>
                                            search information providers [such as [NAME] based [inside <strong>OR</strong> outside] the EU].
                                        </li>
                                    </ol>
                                </li>
                            </ul>
                        ...
                        <li>
                            <p>Contact, Financial and Transaction Data from providers of technical, payment and delivery services [such as [NAME] based [inside <strong>OR</strong> outside] the EU].</p>
                        </li>
                        <li>
                            <p> 
                ...
                <li id="transfers">
                    ...
                    <p>
                        We may transfer your personal data outside the European Economic Area (<strong>EEA</strong>).
                    </p>
                </li>
                <li id="security">
                    <h4>
                ...
                <li id="glossary">
                    ...
                    <p>
                        <strong>Comply with a legal or regulatory obligation</strong> means processing your personal data where it is necessary for compliance with a legal or regulatory obligation that we are subject to.
                    </p>
                    <h4>
                        THIRD PARTIES
                    </h4>
                    ...
                    <ul>
                        ...
                        <li>
                            <p>HM Revenue & Customs, regulators and other authorities acting as processors based in the United Kingdom who may require reporting of processing activities in certain circumstances.</p>
                        </li>
                        <li>
                            <p>Instant VAT Number (256 bit encryption) Validation & EU VAT Rates API by VATLAYER Amazon Europe Core S.A.R.L <a rel="noopener noreferrer" target="_blank" href="https://vatlayer.com">https://vatlayer.com</a></p>
                        </li>
                    </ul>
                    <h4>
                        YOUR LEGAL RIGHTS
