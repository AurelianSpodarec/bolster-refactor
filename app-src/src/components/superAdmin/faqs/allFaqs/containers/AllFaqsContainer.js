...
import fetchAllFaqs from 'actions/superAdmin/faqs/async/fetchAllFaqs';
import deleteFaqs from 'actions/superAdmin/faqs/async/deleteFaqs';

const AllFaqsContainer = () => {
    const history = useHistory();
    const dispatch = useDispatch();
    const { faqs, isFetching } = useSelector(state => state.superAdmin.faqsReducer);
