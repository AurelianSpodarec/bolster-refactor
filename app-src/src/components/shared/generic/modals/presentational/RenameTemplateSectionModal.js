...
const RenameTemplateSectionModal = ({
    name,
    handleChange,
    handleSubmit,
    hideModal
    ...
    <ModalOuterContainer>
        <BlockHeadingWControls title="Rename Section" />
        ...
        <Form className="generic-form" onSubmit={handleSubmit}>
            ...
            <BlockButtonWrapper>
                <button className="button ">
                    <i className="fa fa-pencil" /> Rename Section
                </button>
...
export default RenameTemplateSectionModal;
